  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link href="/dashboard/inventory/lost-stock">
          <Card className="hover:bg-muted/50 transition-colors cursor-pointer h-full border-amber-200 dark:border-amber-900 bg-amber-50/50 dark:bg-amber-950/20">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-amber-900 dark:text-amber-100">بررسی و ترمیم</div>
              <p className="text-xs text-amber-600 dark:text-amber-400">
                سفارش‌های لغوشده‌ای که کالایشان به انبار بازنگشته است
              </p>
            </CardContent>
          </Card>
        </Link>
